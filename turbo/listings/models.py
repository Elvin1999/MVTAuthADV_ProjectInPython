...
class Listing(models.Model):
    ...
    status = models.CharField(max_length=20,choices=STATUS_CHOICES,default=ListingStatus.PENDING)
    ...
    def save(self,*args,**kwargs):
        ...
        if self.pk is not None:
            ...
            changed_fields=[]
            for f in ['title','description','price','city','brand','model','year','mileage','fuel','main_image','gearbox']:
